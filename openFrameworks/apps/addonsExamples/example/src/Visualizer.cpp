...
void Visualizer::draw(ofVec3f v1, ofVec3f v2, ofVec3f v3, ofVec3f v4)
{
	ofSetColor(255, 255);
    ...
    shader.begin();
        ...
        // draw to screen
        /*glBegin(GL_QUADS);  
            glTexCoord2f(v1.x, v1.y);			glVertex2f(0, 0);  
            glTexCoord2f(v2.x, v2.y);			glVertex2f(WIDTH, 0);  
            glTexCoord2f(v3.x, v3.y);			glVertex2f(WIDTH, HEIGHT); 
            glTexCoord2f(v4.x, v4.y);			glVertex2f(0, HEIGHT);   
        glEnd(); */
		glBegin(GL_QUADS);  
            glTexCoord2f(0, 0);				glVertex2f(v1.x, v1.y);  
            glTexCoord2f(WIDTH, 0);			glVertex2f(v2.x, v2.y);  
            glTexCoord2f(WIDTH, HEIGHT);	glVertex2f(v3.x, v3.y); 
            glTexCoord2f(0, HEIGHT);		glVertex2f(v4.x, v4.y);   
        glEnd();
    shader.end();  
