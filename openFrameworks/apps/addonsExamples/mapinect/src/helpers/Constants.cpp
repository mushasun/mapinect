...
namespace mapinect
{
	...
	float				Constants::TOUCH_TABLE_BORDER_TOLERANCE				= 0.05f;
	...
	void Constants::LoadConstants()
	{
		...
		if(XML.loadFile("PCM_Config.xml"))
		{
			...
			TOUCH_TABLE_BORDER_TOLERANCE			= XML.getValue(PCM_CONFIG "TOUCH_TABLE_BORDER_TOLERANCE", TOUCH_TABLE_BORDER_TOLERANCE);
