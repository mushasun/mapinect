...
//---------------------------------------------------------------------------
ofPixels_<unsigned char>& ofxKinect::getPixelsRef(){
	return videoPixels_;
}
...
//------------------------------------
ofVec3f ofxKinect::getScreenCoordsFromWorldCoords(const ofVec3f &worldCoord) {
	return calibration.getScreenCoordsFromWorldCoords(worldCoord);
}
